...
**Phase 3: OW Map + Physics** — IN PROGRESS (2026-06-07). T-B13 ✅ T-B14 ✅ T-B15 ✅ T-B16 ✅. OW map POC COMPLETE (2026-06-08). **Tier 1 fixes SHIPPED (2026-06-08)** — Fix 1 dual-sphere wall penetration ✅ Fix 2 normalY step-climb ✅ Fix 3 MapDescriptor + spawn ✅ IAbilityLab/DoomfistLab ✅. **Health pack substructure SHIPPED (2026-06-08)** — entity survey (64 markers / 12 types catalogued) + `HealthPackExtractor` GLB traversal + `HealthPackManager` rotation/pickup/cooldown + `HealthPackConfig` in `MapDescriptor` + 3-layout rotation for Château Guillard. **T-B17 round structure next.**
